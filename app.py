...
# 2. 데이터 설정
# ==========================================
st.set_page_config(layout="wide", page_title="Load Planner (Pure Python)")
...
def run_optimization(all_items):
    ...
    for t_name in truck_types_by_cost:
        ...
        temp_truck = Truck(t_name, spec['w'], 1300, spec['l'], spec['weight'], spec['cost'])
...
# 5. 메인 UI
# ==========================================
st.title("📦 Ultimate Load Planner (Zero Error Ver)")
