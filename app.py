...
# ==========================================
# 4. 시각화 (3D 애니메이션 - 함수명 수정됨)
# ==========================================
def draw_truck_3d_animated(truck, limit_count=None):
    fig = go.Figure()
    ...
    # 3. Figure 초기화 및 Trace 추가 (초기 상태: 모두 보임)
    ...
    fig.update_layout(
        ...
        sliders=[dict(
            ...
            active=num_boxes - 1, # 초기 슬라이더 위치: 끝
